		...
		<div id="container">
			<div class="content">
				...
				<div class="right_cont">
					<div class="inner">
						<span>메뉴타이틀등록</span>
						<form action="menuChoiceModify" method="post" name="frm" onsubmit="return check();">
						<input type="hidden" value="${dto.menuId }" name="menuId" />
						<input type="hidden" value="${dto2.menuChoiceNum }" name="menuChoiceNum" />
							<table>
								<tr>
									<th>메뉴명</th>
									<td>${dto.menuName }</td>
								...
								<tr>
									<th>옵션타이틀</th>
									<td><input type="text" name="choiceTitle" value="${dto2.choiceTitle }"/></td>
								</tr>
								<tr>
									<th>필수/선택</th>
									<td>
